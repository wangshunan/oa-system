...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <!--系统标题-->
        <div class="layui-logo" style="font-size:18px">OAシステム</div>
        <!--右侧当前用户信息-->
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:void(0)">
                    ...
                    <!--用户信息-->
                    ${current_employee.name}[${current_department.name}-${current_employee.title}]
                </a>
            </li>
            <!--注销按钮-->
            <li class="layui-nav-item"><a href="/imooc_oa/logout">ログアウト</a></li>
        </ul>
    </div>
    <!--左侧菜单栏-->
